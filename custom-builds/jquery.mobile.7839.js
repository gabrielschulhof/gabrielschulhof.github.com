...
* Git HEAD hash: 7f4754f864f7286597d2feaa6fbde5b3b711aa30 <> Date: Sat Nov 29 2014 22:10:48 UTC
...
(function( $, undefined ) {
	...
	$.widget( "mobile.toolbar", $.mobile.toolbar, {
		...
		_create: function() {
			this._super();
			if ( this.window[ 0 ].findPagecontainerUnconditionally ) {
				this.pagecontainer = $( ":mobile-pagecontainer" );
			}
			if ( this.options.position === "fixed" && !this.options.supportBlacklist() ) {
				this.pagecontainer = this.pagecontainer || this.element.closest( ":mobile-pagecontainer" );
				this._makeFixed();
			}
		},
