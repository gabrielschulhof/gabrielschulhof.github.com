...
$.mobile.enhanceWithButtonMarkup = enhanceWithButtonMarkup;
...
$.mobile.enhanceWithButtonMarkup2 = enhanceWithButtonMarkup;
...
function enhanceWithButtonMarkup( idx, el ) {
	...
	$el[ 0 ] = el;
	$el.addClass( optionsToClasses( $.extend( {},
		$.fn.buttonMarkup.defaults, {
			icon      : getAttrFixed( el, "icon",       true ),
			iconpos   : getAttrFixed( el, "iconpos",    true ),
			theme     : getAttrFixed( el, "theme",      true ),
...
$.mobile.enhanceWithButtonMarkup3 = enhanceWithButtonMarkup;
